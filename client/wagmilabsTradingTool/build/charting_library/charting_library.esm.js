...
const e = {
    ...
    library_path: "",
    locale: "en",
    widgetbar: { details: !1, watchlist: !1, news: !1, datawindow: !1, watchlist_settings: { default_symbols: [] } },
    ...
    favorites: { intervals: [], chartTypes: [], drawingTools: [] },
  },
  n = JSON.parse(
...
function s(t, e) {
  var i;
  const s = new URL(`${t || ""}`, location.href).href,
    r = JSON.parse(
      '["bundles/runtime.dabbddb8e0cf198a3951.js","bundles/__LANG__.7076.5055b5f097e7204685ed.js","bundles/7717.8f75bd75d4b6ed45f3ff.css","bundles/7717.8f75bd75d4b6ed45f3ff.rtl.css","bundles/4618.e46ad0a894862e22afb5.js","bundles/library.fa294554299772125cc4.js","bundles/EuclidCircular.be8f862db48c2976009f.woff2"]'
    ),
    a = encodeURIComponent(e),
    d = null !== (i = n.find(t => t.language === a)) && void 0 !== i ? i : { iso: "en", dir: "ltr" },
    l = `lang="${d.iso}" dir="${d.dir}"`,
    h = `\n${(function (t, e, n) {
      if (void 0 === t) return "";
      const i = [],
        s = [],
      ...
      for (const l of t)
        l.endsWith(".js")
          ? s.push(`<script defer crossorigin="anonymous" src="${l.replace("__LANG__", n)}"><\/script>`)
          : a.test(l) && e === d.test(l)
          ? r.push(`<link type="text/css" href="${l}" rel="stylesheet"/>`)
          : /\.woff\d*/.test(l) && i.push(o(l));
      return [...i, ...s, ...r].join("\n");
    })(r, "rtl" === d.dir, a)}\n`;
  return `<!DOCTYPE html><html ${
    (c = { bundles: h, localeLanguage: a, htmlAttrs: l, libraryPath: s }).htmlAttrs
  }><head><base href="${
    c.libraryPath
...
function r() {
  return "CL v24.003 (internal id 95d3a7ef @ 2023-04-11T15:37:39.177Z)";
}
const a = class {
  constructor(n) {
    var o;
    ...
    (null === (o = n.overrides) || void 0 === o ? void 0 : o["mainSeriesProperties.priceAxisProperties.lockScale"]) &&
      (console.warn(
      ...
      this._options.debug &&
        (i || ((i = !0), console.log("Using CL v24.003 (internal id 95d3a7ef @ 2023-04-11T15:37:39.177Z)"))),
      this._create();
  }
  setDebugMode(t) {
  ...
  _create() {
    ...
    const s = this._options.container_id || this._options.container,
    ...
    n &&
      (a.contentWindow
        ? (a.contentWindow.document.open(), a.contentWindow.document.write(o), a.contentWindow.document.close())
        : console.warn(
  ...
  _render(t) {
    ...
    const i = s(this._options.library_path || "", this._options.locale);
...
"undefined" != typeof window && ((window.TradingView = window.TradingView || {}), (window.TradingView.version = r));
export { r as version, a as widget };
