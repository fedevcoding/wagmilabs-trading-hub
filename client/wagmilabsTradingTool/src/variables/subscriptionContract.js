const subscriptionAddress = "0x93eA2C0aA323F9e7abf8dfEDBe776011f6eAE680";
...
const subscriptionsAbi = [
  ...
  {
    inputs: [
      { internalType: "uint8", name: "_mintAmount", type: "uint8" },
  ...
  {
    inputs: [{ internalType: "address", name: "newOnwer", type: "address" }],
    name: "changeOwner",
    outputs: [],
  ...
  {
    inputs: [{ internalType: "address", name: "_subscriptionAddress", type: "address" }],
    name: "setSubscriptionAddress",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "minMonths", type: "uint256" },
      { internalType: "uint256", name: "maxMonths", type: "uint256" },
    ],
    name: "updateRenewalMonths",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
