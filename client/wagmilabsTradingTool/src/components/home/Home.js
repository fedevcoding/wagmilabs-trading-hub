    ...
    case "trending":
      return (
        <>
          ...
          <div className='trending-10M' onClick={e => changeTime(e, "10M")}>10M</div>
          <div className='trending-30M' onClick={e => changeTime(e, "30M")}>30M</div>
          <div className='trending-1H' onClick={e => changeTime(e, "1H")}>1H</div>
          <div className='trending-4H' onClick={e => changeTime(e, "4H")}>4H</div>
          <div className='trending-12H' onClick={e => changeTime(e, "12H")}>12H</div>
          <div className='trending-1D' onClick={e => changeTime(e, "1D")}>1D</div>
          <div className='trending-7D' onClick={e => changeTime(e, "7D")}>7D</div>
        </>
      )
    case "minting":
      return (
        <>
          ...
          <div className="minting-5M" onClick={e => changeTime(e, "5M")}>5M</div>
          <div className="minting-15M" onClick={e => changeTime(e, "15M")}>15M</div>
          <div className="minting-30M" onClick={e => changeTime(e, "30M")}>30M</div>
          <div className="minting-1H" onClick={e => changeTime(e, "1H")}>1H</div>
          <div className="minting-6H" onClick={e => changeTime(e, "6H")}>6H</div>
          <div className="minting-1D" onClick={e => changeTime(e, "1D")}>1D</div>
        </>
      )
    case "ranking":
      return (
        <>
          ...
          <div className='ranking-10M' onClick={e => changeTime(e, "10M")}>10M</div>
          <div className='ranking-30M' onClick={e => changeTime(e, "30M")}>30M</div>
          <div className='ranking-1H' onClick={e => changeTime(e, "1H")}>1H</div>
          <div className='ranking-4H' onClick={e => changeTime(e, "4H")}>4H</div>
          <div className='ranking-12H' onClick={e => changeTime(e, "12H")}>12H</div>
          <div className='ranking-1D' onClick={e => changeTime(e, "1D")}>1D</div>
          <div className='ranking-7D' onClick={e => changeTime(e, "7D")}>7D</div>
        </>
      )
    case "owned":
      return (
        <>
          ...
          <div className='owned-30D' onClick={e => changeTime(e, "30D")}>30D</div>
        </>
      )
    case "watchlist":
      return (
