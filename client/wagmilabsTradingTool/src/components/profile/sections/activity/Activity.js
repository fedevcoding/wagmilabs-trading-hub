...
import { Button, HStack, Input, NumberInput, NumberInputField, Select, Spinner } from '@chakra-ui/react'
      ...
      <>
        <tr key={key} className={`profile-activity-single-container ${isLast && "last-token"}`}>
          ...
          <td className='profile-activity-single-token'>
            <img src={tokenImage || nftNotFound} alt="" className="profile-activity-single-image" />
            ...
            <table className='profile-activity-table'>
              ...
              <tbody>
                ...
                }
                {
                  ...
                  <tr><td colSpan={6}><div className='loading'>Loading more activity   <svg className="spinner" width="65px" height="65px" viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg"><circle className="path" fill="none" strokeWidth="6" strokeLinecap="round" cx="33" cy="33" r="30"></circle></svg>     </div></td></tr>
                }
              </tbody>
            </table>
          </div>
