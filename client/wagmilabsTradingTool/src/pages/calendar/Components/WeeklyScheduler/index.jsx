...
export const WeeklyScheduler = React.memo(
  ({ hoursIntervals, sectionData, showSelectedDate }) => {
    console.log("sectionData in WeeklyScheduler", sectionData);
    ...
    console.log("allEventsInAllWeakdays", allEventsInAllWeakdays);
    console.log("usedHoursBlocks", usedHoursBlocks);
