...
export const PriceBox = React.memo(({ details, address, currency, ownerBestListing, isErc721 }) => {
          ...
          <Row className="actions">
            {ownerBestListing ? (
              ...
              <>
                ...
                <Col>
                  <BuyNow details={details} address={address} tokenId={tokenId} value={value} quantity={quantity} />
                </Col>
              </>
            )}
          </Row>
