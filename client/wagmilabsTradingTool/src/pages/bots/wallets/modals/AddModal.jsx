          ...
          <ModalContent className="add-wallet-modal">
            ...
            <ModalBody>
              <div className="form">
                <div className="options">
                  <p
                    onClick={() => dispatch({ type: "SET_TYPE", payload: "use" })}
                    className={`${data.type === "use" && "active"}`}
                  >
                    Use
                  </p>
                  <p
                    onClick={() => dispatch({ type: "SET_TYPE", payload: "generate" })}
                    className={`${data.type === "generate" && "active"}`}
                  >
                    Generate
                  </p>
                </div>
            ...
            <ModalFooter justifyContent={"center"}>
              <Button
                ...
                className={`add-button ${hasAddConditions && "active"}`}
              >
                {loading ? <Loader width={"20px"} height={"20px"} /> : <p>Add!</p>}
              </Button>
            </ModalFooter>
          </ModalContent>
        </Modal>
